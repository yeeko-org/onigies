...
- [ ] dashboard-collections documenta que un EditSimple puede emitir item-saved y PanelCommon lo reenvía (sincronización renglón↔detalle)
- [ ] flow documenta el save() completo del motor (_save_status) y que gen ya corre en vivo con sus superficies
- [ ] gen-general-info refleja las banderas nuevas de Sector, GeneralGroup.order, el candado de período y dónde vive la captura (componentes de survey/)
