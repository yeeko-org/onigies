...
| `respuestas-tabs.test.ts` | chips del card ligados a su `?tab=`, navegación al tab correcto, deep-link que sobrevive a la recarga, y recarga con catálogos lentos que conserva el `?tab=` del eje |
