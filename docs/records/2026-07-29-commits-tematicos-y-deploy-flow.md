...
- Pendientes que quedaron abiertos:
  ...
  - 🚧 [code:docs/records/2026-06-26-seguimiento-pendientes-ruben.md] Marcar el §5 (cutover de archivos en el server) como hecho.
  ...
  - 🚧 [open:fase de borrado §8 del plan de flujo] Quitar `StatusControl` y los campos/modelos viejos coexistentes (ver `docs/records/2026-06-05-diseno-del-motor-de-flujo.md`).
  - 🚧 [open:respuestas del cliente a docs/records/2026-07-03-dudas-del-instrumento-con-el-cliente.md] Resolver las dudas del cuestionario y decidir la ventana para desplegar el seed (`9eadc9e`) a producción.
