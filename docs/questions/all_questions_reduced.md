...
> Este documento reduce `all_questions.md` eliminando boilerplate repetido
...
> `pendientes_revision_cuestionario.md` para erratas y decisiones abiertas.
...
y "Público en general", ver `pendientes_revision_cuestionario.md`)*
