...
type: task
id: task-38
title: Aplicar el design system al dashboard
state: open
date: 2026-05-26
owner: ai
parent: "[[task-3]]"
...
- [ ] Fase 0 (limpieza inmediata) resuelta, incluidas las tres decisiones pendientes que trae
- [ ] Tokens, tipografía e iconografía del design system cargados globalmente
- [ ] Las fases 2 en adelante aplicadas o abandonadas con su razón escrita

Propuestas para implementar — en sesiones futuras — el
design system de `design-system/` sobre el dashboard
...
1. **Importar `colors_and_type.css` como hoja global.**
   ...
   css: [
     ...
     // o referencia directa: '../design-system/project/colors_and_type.css'
   ]
   ```
...
1. **Sidebar fijo (248px) en índigo `--indigo-700`.**
   ...
   - El sidebar conserva el patrón "secciones agrupadas" del design
     ...
     `design-system/project/ui_kits/admin_dashboard/Sidebar.jsx`).
