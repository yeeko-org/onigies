...
- [ ] El encabezado de cada grupo se pinta una sola vez, desde el catálogo
- [ ] Ningún componente de grupo tiene texto introductorio escrito en el código
- [ ] Los cuatro componentes reciben el mismo contrato
- [ ] El montaje es por mapa estático y `<component :is>`, sin cadena de condicionales
- [ ] `readonly` y `disabled` significan lo mismo en las dos tablas
